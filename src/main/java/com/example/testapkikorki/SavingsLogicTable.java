...
public class SavingsLogicTable {
    ...
    @FXML
    private TableColumn<Generic, String> quantityColumn, dateColumn;
    ...
    public BorderPane savingsInTableBorderPane;
    ...
    public void initialize(){
        try{
            quantityColumn.setCellValueFactory(new PropertyValueFactory<Generic, String>("quantity"));
            ...
            tableView.setItems(getSavingsForTable());
            FilteredList<Generic> filtered = new FilteredList<>(getSavingsForTable(), b -> true);
    ...
    public void movingWhenDragged(MouseEvent event){
        Stage stage = (Stage) savingsInTableBorderPane.getScene().getWindow();
    ...
    public void checkByDates(ActionEvent event) throws IOException {
        ...
        if(fromDate != null && toDate != null && answer.equals("OK")) {
            tableView.setItems(getSavingsForTableByDates(fromDate.toString(), toDate.toString()));
            FilteredList<Generic> filtered = new FilteredList<>(getSavingsForTableByDates(fromDate.toString(), toDate.toString()), b -> true);
            filterTextField.textProperty().addListener((observable, oldValue, newValue) -> {
                filtered.setPredicate( object -> {
                    if(newValue == null || newValue.isEmpty()){
                        return true;
    ...
    public void reset(Event event) throws IOException {
        FXMLLoader fxmlLoader = new FXMLLoader(HelloApplication.class.getResource("fxml/savingsInTable.fxml"));
    ...
    private ObservableList<Generic> getSavingsForTableByDates(String fromDate, String toDate){
        String sqlQuery = "SELECT * FROM savings WHERE date BETWEEN ? AND ?;";
    ...
    private ObservableList<Generic> getSavingsForTable(){
